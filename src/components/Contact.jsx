...
const Contact = () => {
  return (
    <div name='contact' className=' w-full h-screen p-4 bg-gradient-to-b from-black  to-gray-800 text-white'>
        <div className=' flex flex-col p-4 justify-center max-w-screen-lg mx-auto h-full     '>
            ...
            <div className='flex justify-center items-center'>
                <form 
                action="https://getform.io/f/a417315e-b38f-4fce-abfb-1071903e7552"
                method='POST' 
                className=' flex flex-col w-full md:w-1/2'>
                    ...
                    className=' bg-transparent border-2 text-white 
                     ...
                     px-6 py-3 my-8 mx-auto flex items-center rounded-md
                      hover:scale-110 duration-500'>Lets talk</button>
                </form>
            </div>
        </div>
    </div>
